...
class MongoDbReplicaSetFaultTolerancePSAApiITTest {
    ...
    void shouldTestFailoverBecauseOfContainerKill() {
        ...
        assertEquals(REPLICA_SET_NUMBER + 1, nodeStatesBeforeFailover.size());
        ...
        assertEquals(REPLICA_SET_NUMBER + 1, actualNodeStatesRightAfterKilling.size());
    ...
    void shouldTestFailoverBecauseOfContainerStop() {
        ...
        assertEquals(REPLICA_SET_NUMBER + 1, actualNodeStatesRightAfterStopping.size());
